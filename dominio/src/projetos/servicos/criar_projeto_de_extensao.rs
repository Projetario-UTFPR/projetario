...
mod test {
    ...
    use crate::projetos::servicos::criar_projeto_de_extensao::CriarProjetosDeExtensaoParams;
    use crate::projetos::servicos::criar_projeto_de_extensao::ServicoCriarProjetoDeExtensao;
