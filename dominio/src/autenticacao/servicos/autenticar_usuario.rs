...
use comum::erros::resultado_de_dominio::ResultadoDominio;

use crate::autenticacao::ComparadorDeHashDeSenha;
use crate::identidade::entidades::usuario::UsuarioModelo;
use crate::identidade::politicas::registro_de_aluno::valide_registro_de_aluno;
...
mod test {
    ...
    use crate::autenticacao::HasherDeSenha;
    use crate::autenticacao::servicos::autenticar_usuario::{
        AutenticarUsuarioParams,
        AutenticarUsuarioResult,
        ServicoAutenticarUsuario,
        TipoDeLogin,
    };
    use crate::test::comparador_e_hasher_de_senhas::ComparadorEHasherDeSenhaFake;
    ...
    fn sut() -> Sut {
        ...
        let professor = UsuarioModeloParcial {
