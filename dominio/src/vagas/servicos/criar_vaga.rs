...
mod test {
    ...
    use crate::vagas::servicos::criar_vaga::{CriarVagaParams, ServicoCriarVaga};
    use comum::sqlx::{db_date_time_now, DbDateTime};
    use crate::test::fabricas_de_entidades::usuario_modelo::UsuarioModeloParcial;
    use crate::test::repositorios_em_memoria::coordenadores_de_projetos::{ProjetoCoordenadorTupla, RepositorioDeCoordenadoresDeProjetosEmMemoria};
    use crate::test::repositorios_em_memoria::fabricas::fabrica_repositorio_de_coordenadores_de_projetos::FabricaRepositorioDeCoordenadoresDeProjetos;
    use crate::test::repositorios_em_memoria::fabricas::fabrica_repositorio_de_usuarios::FabricaRepositorioDeUsuarios;
    use crate::test::repositorios_em_memoria::fabricas::fabrica_repositorio_de_vagas::FabricaRepositorioDeVagas;
    use crate::test::repositorios_em_memoria::usuarios::RepositorioDeUsuariosEmMemoria;
    ...
    fn obtehna_servico_e_repos() -> ServicoERepos {
        ...
        let repo_de_usuarios = FabricaRepositorioDeUsuarios::obtenha_repositorio();
        repo_de_projetos.usuarios_tbl = repo_de_projetos.usuarios_tbl.clone();
        let repo_de_vagas = FabricaRepositorioDeVagas::obtenha_repositorio();
