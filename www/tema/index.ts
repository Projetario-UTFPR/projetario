...
export function atualizarHtmlComNovoTema(tema: Tema, temaPreferido: TemaDoSistema | null) {
...
export function resolvaTema(tema: Tema, temaDoSistema: TemaDoSistema | null): TemaEstrito {
